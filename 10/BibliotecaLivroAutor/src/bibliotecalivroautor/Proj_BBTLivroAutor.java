package com.oo.proj_bbtlivroautor;

import com.oo.proj_bbtlivroautor.entity.Autor;
import com.oo.proj_bbtlivroautor.classes.Biblioteca;
import com.oo.proj_bbtlivroautor.classes.Livro;
 ...
 * @author jose
 */
public class Proj_BBTLivroAutor {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 4: // pesquisa livro pelo nome do autor
                    ...
                    livro = bbt.findBookByAuthor(nomeAutorParaBuscar);
                    livro.imprimir();
                    break;
                ...
                case 5: // pesquisa autor pela cidade natal
                    ...
                    List<Autor> lstAutores = bbt.findAuthorByCity(cidadeParaBuscar);
